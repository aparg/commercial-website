...
const Navbar = (props) => {
  ...
  const rentOpts = [
    {
      name: "Convenience Store for Lease" + inCity,
      link: generateURL({
        houseTypeVal: "convenience store",
        saleLeaseVal: "lease",
        cityVal: cityName,
    ...
    {
      name: "Restaurant for Lease" + inCity,
      link: generateURL({
        houseTypeVal: "restaurant",
        saleLeaseVal: "lease",
        cityVal: cityName,
    ...
    {
      name: "Gas Station for Lease" + inCity,
      link: generateURL({
        houseTypeVal: "gas statioin",
        saleLeaseVal: "lease",
        cityVal: cityName,
      }),
    },
