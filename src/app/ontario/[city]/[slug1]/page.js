...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...
    description: `500+ ${formattedCity} ${type} properties for sale. Book a showing for affordable homes with pools, finished basements, walkouts. Prices from $1 to $5,000,000. Open houses available.`,
  };
}
